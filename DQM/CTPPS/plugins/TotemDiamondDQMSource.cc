...
class TotemDiamondDQMSource: public DQMEDAnalyzer
{
  public:
    TotemDiamondDQMSource(const edm::ParameterSet& ps);
    virtual ~TotemDiamondDQMSource();
...
void TotemDiamondDQMSource::GlobalPlots::Init(DQMStore::IBooker &ibooker)
{
...
TotemDiamondDQMSource::DiagonalPlots::DiagonalPlots(DQMStore::IBooker &ibooker, int _id) : id(_id)
{
  bool top45 = id & 2;
  bool top56 = id & 1;
...
TotemDiamondDQMSource::ArmPlots::ArmPlots(DQMStore::IBooker &ibooker, int _id) : id(_id)
{
...
TotemDiamondDQMSource::StationPlots::StationPlots(DQMStore::IBooker &ibooker, int id) 
{
...
TotemDiamondDQMSource::PotPlots::PotPlots(DQMStore::IBooker &ibooker, unsigned int id)
{
...
TotemDiamondDQMSource::PlanePlots::PlanePlots(DQMStore::IBooker &ibooker, unsigned int id)
{
...
TotemDiamondDQMSource::TotemDiamondDQMSource(const edm::ParameterSet& ps) :
...
TotemDiamondDQMSource::~TotemDiamondDQMSource()
{
}

//----------------------------------------------------------------------------------------------------

void TotemDiamondDQMSource::dqmBeginRun(edm::Run const &, edm::EventSetup const &)
{
}

//----------------------------------------------------------------------------------------------------

void TotemDiamondDQMSource::bookHistograms(DQMStore::IBooker &ibooker, edm::Run const &, edm::EventSetup const &)
{
  ibooker.cd();
...
void TotemDiamondDQMSource::beginLuminosityBlock(edm::LuminosityBlock const& lumiSeg, 
...
void TotemDiamondDQMSource::analyze(edm::Event const& event, edm::EventSetup const& eventSetup)
{
  ...
  if (!valid)
  {
    if (verbosity)
    {
      LogProblem("TotemDiamondDQMSource") <<
...
void TotemDiamondDQMSource::endLuminosityBlock(edm::LuminosityBlock const& lumiSeg, edm::EventSetup const& eSetup) 
{
}

//----------------------------------------------------------------------------------------------------

void TotemDiamondDQMSource::endRun(edm::Run const& run, edm::EventSetup const& eSetup)
{
}

//----------------------------------------------------------------------------------------------------

DEFINE_FWK_MODULE(TotemDiamondDQMSource);

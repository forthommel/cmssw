...
profile_2018_preTS1 = _base_2018.clone(
    ...
    ctppsRPAlignmentCorrectionsDataXML = _base_2018.ctppsRPAlignmentCorrectionsDataXML.clone(
        MisalignedFiles = cms.vstring("Validation/CTPPS/alignment/2018_preTS1.xml"),
        RealFiles = cms.vstring("Validation/CTPPS/alignment/2018_preTS1.xml")
    ),
...
profile_2018_TS1_TS2 = _base_2018.clone(
    ...
    ctppsRPAlignmentCorrectionsDataXML = _base_2018.ctppsRPAlignmentCorrectionsDataXML.clone(
        MisalignedFiles = cms.vstring("Validation/CTPPS/alignment/2018_TS1_TS2.xml"),
        RealFiles = cms.vstring("Validation/CTPPS/alignment/2018_TS1_TS2.xml")
    ),
    ctppsDirectSimuData = _base_2018.ctppsDirectSimuData.clone(
...
profile_2018_postTS2 = _base_2018.clone(
    ...
    ctppsRPAlignmentCorrectionsDataXML = _base_2018.ctppsRPAlignmentCorrectionsDataXML.clone(
        MisalignedFiles = cms.vstring("Validation/CTPPS/alignment/2018_postTS2.xml"),
        RealFiles = cms.vstring("Validation/CTPPS/alignment/2018_postTS2.xml")
    ),
    ctppsDirectSimuData = _base_2018.ctppsDirectSimuData.clone(

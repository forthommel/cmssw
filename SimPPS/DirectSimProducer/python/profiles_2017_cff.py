...
profile_2017_preTS2 = _base_2017.clone(
    L_int = cms.double(15.012899190),
    ctppsLHCInfo = _base_2017.ctppsLHCInfo.clone(
        xangleBetaStarHistogramObject = cms.string("2017_preTS2/h2_betaStar_vs_xangle")
    ),
    ctppsRPAlignmentCorrectionsDataXML = _base_2017.ctppsRPAlignmentCorrectionsDataXML.clone(
        MisalignedFiles = cms.vstring("Validation/CTPPS/alignment/2017_preTS2.xml"),
        RealFiles = cms.vstring("Validation/CTPPS/alignment/2017_preTS2.xml")
    ),
    ctppsDirectSimuData = _base_2017.ctppsDirectSimuData.clone(
        empiricalAperture45 = cms.string("-(8.71198E-07*[xangle]-0.000134726)+(([xi]<(0.000264704*[xangle]+0.081951))*-(4.32065E-05*[xangle]-0.0130746)+([xi]>=(0.000264704*[xangle]+0.081951))*-(0.000183472*[xangle]-0.0395241))*([xi]-(0.000264704*[xangle]+0.081951))"),
        empiricalAperture56 = cms.string("3.43116E-05+(([xi]<(0.000626936*[xangle]+0.061324))*0.00654394+([xi]>=(0.000626936*[xangle]+0.061324))*-(0.000145164*[xangle]-0.0272919))*([xi]-(0.000626936*[xangle]+0.061324))"),
        timeResolutionDiamonds45 = cms.string("2*(-0.10784+0.105194*x-0.0182611*x^2+0.00134731*x^3-3.58212E-05*x^4)"),
        timeResolutionDiamonds56 = cms.string("2*(0.00735552+0.0272707*x-0.00247151*x^2+8.62788E-05*x^3-7.99605E-07*x^4)")
    )
)
...
profile_2017_postTS2 = _base_2017.clone(
    ...
    ctppsRPAlignmentCorrectionsDataXML = _base_2017.ctppsRPAlignmentCorrectionsDataXML.clone(
        MisalignedFiles = cms.vstring("Validation/CTPPS/alignment/2017_postTS2.xml"),
        RealFiles = cms.vstring("Validation/CTPPS/alignment/2017_postTS2.xml")
    ),
    ctppsDirectSimuData = _base_2017.ctppsDirectSimuData.clone(
